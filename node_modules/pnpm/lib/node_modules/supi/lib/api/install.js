        ...
        function _install() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const scriptsOpts = {
                    ...
                    modulesDir: yield realNodeModulesDir_1.default(opts.prefix),
                    root: opts.prefix,
                    pkgId: opts.prefix,
                    stdio: 'inherit',
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (opts.shrinkwrapOnly) {
            ...
            if (installCtx.localPackages.length) {
                ...
                yield link_1.default(externalPkgs, installCtx.nodeModules, linkOpts);
                installCtx.localPackages.forEach((localPackage) => __awaiter(this, void 0, void 0, function* () {
