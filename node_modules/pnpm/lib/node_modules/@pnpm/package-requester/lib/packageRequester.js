...
function resolveAndFetch(ctx, wantedDependency, options) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const targetRelative = pkgid_to_filename_1.default(id);
            ...
            try {
                ...
                yield Promise.all([
                    (() => __awaiter(this, void 0, void 0, function* () {
                        ...
                        const fetchedPackage = yield opts.requestsQueue.add(() => opts.fetch(opts.resolution, target, {
